...
class BlockMainContacts extends React.Component {
	render() {
		return (
            <div>
                <div className="Bwrappers page">
                <h1>Contacts</h1>
                    <p>
                        Главный офис: <br /><br />
                        01032, г. Киев, ул. Саксаганского, 70 А <br /><br />
                        Тел .: (+380 44) 225 60 00 <br /><br />
                    </p>
...
export default BlockMainContacts;